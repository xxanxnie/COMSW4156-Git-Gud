...
class FoodUnitTests : public ::testing::Test {
 protected:
  ...
  static void SetUpTestSuite() { food = new Food("Bread", "10 loaves"); }

  static void TearDownTestSuite() { delete food; }
};

// Example test case for Food type
TEST_F(FoodUnitTests, GetType) { EXPECT_EQ(food->getType(), "Bread"); }
