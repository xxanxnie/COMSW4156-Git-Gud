...
TEST_F(RouteControllerUnitTests, GetShelterTest) {
  std::string mockResponse = R"([{"ORG": "NGO", "User": "HML", "location": "NYC"}])";
  ON_CALL(*mockShelter, searchShelterAll()).WillByDefault(::testing::Return(mockResponse));
...
TEST_F(RouteControllerUnitTests, AddShelterTest) {
  std::string body = R"({"ORG": "NGO", "User": "HML", "location": "NYC", "capacity": "100", "curUse": "20"})";
  crow::request req;
  req.body = body;
  crow::response res{};

  ON_CALL(*mockShelter, addShelter("NGO", "HML", "NYC", 100, 20)).WillByDefault(::testing::Return("Success"));
...
TEST_F(RouteControllerUnitTests, GetCounselingTest) {
  std::string mockResponse = R"([{"name": "John Doe", "specialty": "CBT"}])";
  ON_CALL(*mockCounseling, searchCounselorsAll()).WillByDefault(::testing::Return(mockResponse));
...
TEST_F(RouteControllerUnitTests, AddCounselingTest) {
  std::string body = R"({"counselorName": "Jane Smith", "specialty": "Family Therapy"})";
  crow::request req;
  req.body = body;
  crow::response res{};

  ON_CALL(*mockCounseling, addCounselor("Jane Smith", "Family Therapy")).WillByDefault(::testing::Return("Success"));
...
TEST_F(RouteControllerUnitTests, GetAllFoodTest) {
  std::string mockResponse = R"([{"name": "FoodBank", "location": "NYC"}])";
  ON_CALL(*mockFood, getAllFood()).WillByDefault(::testing::Return(mockResponse));
...
TEST_F(RouteControllerUnitTests, AddFoodTest) {
  ...
  ON_CALL(*mockFood, addFood(expectedContent)).WillByDefault(::testing::Return("Success"));
...
TEST_F(RouteControllerUnitTests, GetAllOutreachServicesTest) {
  std::string mockResponse = R"([{"programName": "OutreachProgram"}])";
  ON_CALL(*mockOutreach, getAllOutreachServices()).WillByDefault(::testing::Return(mockResponse));
...
TEST_F(RouteControllerUnitTests, AddOutreachServiceTest) {
  std::string body = R"({"targetAudience": "Youth", "programName": "OutreachProgram", "description": "Help", "programDate": "2023-01-01", "location": "NYC", "contactInfo": "123-456"})";
  crow::request req;
  req.body = body;
  crow::response res{};

  ON_CALL(*mockOutreach, addOutreachService("Youth", "OutreachProgram", "Help", "2023-01-01", "NYC", "123-456")).WillByDefault(::testing::Return("Success"));
...
TEST_F(RouteControllerUnitTests, GetAllHealthcareServicesTest) {
  std::string mockResponse = R"([{"provider": "HealthcareProvider"}])";
  ON_CALL(*mockHealthcare, getAllHealthcareServices()).WillByDefault(::testing::Return(mockResponse));
...
TEST_F(RouteControllerUnitTests, AddHealthcareServiceTest) {
  std::string body = R"({"provider": "HealthcareProvider", "serviceType": "General Care", "location": "NYC", "operatingHours": "9-5", "eligibilityCriteria": "None", "contactInfo": "123-456"})";
  crow::request req;
  req.body = body;
  crow::response res{};

  ON_CALL(*mockHealthcare, addHealthcareService("HealthcareProvider", "General Care", "NYC", "9-5", "None", "123-456")).WillByDefault(::testing::Return("Success"));;
